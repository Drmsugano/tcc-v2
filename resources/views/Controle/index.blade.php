            ...
            <div class="col-md-6 col-lg-4">
                <div class="card shadow border-0 h-100 hover-card">
                    <div class="card-body text-center">
                        ...
                        <a href="{{ route('controle.obras') }}" class="btn btn-outline-primary mt-2">
                            Acessar
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card shadow border-0 h-100 hover-card">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted">Acesse o controle de fornecedores.</p>
                        <a href="{{ route('controle.fornecedores') }}" class="btn btn-outline-primary mt-2">
                            Acessar
                        </a>
                    </div>
                </div>
